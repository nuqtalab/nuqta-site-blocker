# Privacy Policy – Nuqta Site Blocker

**Effective Date:** January 2026

Nuqta Site Blocker is a Chrome extension designed to help users stay focused and productive by blocking distracting websites and content. Your privacy is important to us, and this Privacy Policy explains how we handle user data.
...
This functionality exists only to support keyword-based content blocking.
...
are stored locally using Chrome’s `storage` API and are used only to provide core functionality.
...
The extension only requests permissions necessary to:
- Block websites selected by the user
...
Nuqta Site Blocker does not knowingly collect data from children under the age of 13.
...
If you have questions, concerns, or feedback about this Privacy Policy or the extension, please contact us using the support form below:

**Support Link:**  
https://forms.gle/4qJJTZ2GwKq948Nd8

---

By using Nuqta Site Blocker, you agree to this Privacy Policy.
